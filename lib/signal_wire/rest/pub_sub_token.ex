defmodule SignalWire.PubSubToken do 
  @moduledoc """
  Represents a PubSub Token resource in the Signal Wire API.

  - [Signal Wire docs](https://developer.signalwire.com/rest/generate-a-new-pub-sub-token)
  """

  import SignalWire.Utils

  @url "/api/pubsub/tokens"
