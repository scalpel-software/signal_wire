defmodule SignalWire.VideoRoom do 
  @moduledoc """
  Represents an Video Room resource in the Signal Wire API.

  - [Signal Wire docs](https://developer.signalwire.com/rest/list-video-rooms)
  """

  import SignalWire.Utils

  @url "/api/fabric/video_rooms"
