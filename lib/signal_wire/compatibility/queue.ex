defmodule SignalWire.Queue do 
  @moduledoc """
  Represents a Queue resource in the Signal Wire API.

  - [Signal Wire docs](https://developer.signalwire.com/compatibility-api/rest/list-all-queues)
  """

  import SignalWire.Utils

  @url "/api/laml/2010-04-01/Accounts/:account_id/Queues"
  ...
  def list(account_id, query \\ %{}) do 
    list(SignalWire.client(), account_id, query)
  end
  ...
  def list(client, account_id, query) do 
    case Tesla.get!(client, build_url(@url, [account_id: account_id], query)) do 
      %Tesla.Env{body: body, status: 200} -> 
        {:ok, as_struct(__MODULE__, Map.get(body, "queues", [])), paging(body)}
