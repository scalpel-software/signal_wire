defmodule SignalWire.AvailableTollFreeNumber do 
  @moduledoc """
  Represents an Available Toll Free Number resource in the Signal Wire API.

  - [Signal Wire docs](https://developer.signalwire.com/compatibility-api/rest/find-toll-free-numbers)
  """

  import SignalWire.Utils

  @url "/api/laml/2010-04-01/Accounts/:account_id/AvailablePhoneNumbers/:country/TollFree"
